...
let cls = i<30 ? "kd-good" : i<60 ? "kd-mid" : "kd-bad";
...
let s1Color = m.s1>m.s2 ? "style='color:#00ff88;font-weight:bold'" : "style='color:#ff0033;font-weight:bold'";
let s2Color = m.s2>m.s1 ? "style='color:#00ff88;font-weight:bold'" : "style='color:#ff0033;font-weight:bold'";

return `
<div>
${m.t1} <span ${s1Color}>${m.s1}</span>
 - 
<span ${s2Color}>${m.s2}</span> ${m.t2}
</div>`;
}).join("");
}
